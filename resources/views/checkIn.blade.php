  ...
  <header class="w-100">
    ...
    <div style="margin-top: 9vh; margin-left: 26.5vh" class="w-75 h-75">
      ...
      <div class="row mb-3">
        ...
        <div class="card-deck d-flex justify-content-center w-100 flex-wrap">
          <a href="/checkInClick" class="btn btn-primary" style="margin-top: 9vh; background-color: #456268; border-color: #456268; border-radius:15px; font-size: 20px;">Check In</a>
        </div>
    </div>
    </div>
