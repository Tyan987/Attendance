...
<body style="background-color: #79A3B1">
  <header class="w-100">
    ...
    <div style="margin-top: 9vh; margin-left: 26.5vh" class="w-75 h-75">
      <h3 class="mb-3 text-center fs-1" style="padding-top: 2vh; color: white">Check In</h3>
      <table class="table" style="margin-top: 9vh; text-align: center; background-color: #D0E8F2; border-radius: 15px; color: #456268">
        <thead>
          <tr>
            <th scope="col">Date</th>
            <th scope="col">Check In</th>
            <th scope="col">Check Out</th>
            <th scope="col">Late Duration (min)</th>
            <th scope="col">Over Time Duration (min)</th>
            <th scope="col">Early Check Out Duration (min)</th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr>
            ...
            <td>{{$attend->late_duration}}</td>
            <td>{{$attend->over_time_duration}}</td>
            <td>{{$attend->early_check_out_duration}}</td>
          </tr>
          @endforeach
        </tbody>
      </table>
