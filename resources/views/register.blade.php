...
<body style="background-color: #79A3B1">
    <header>
        <nav class="navbar navbar-light" style="background-color: #456268">
            ...
            <a class="navbar-brand ms-5 fs-4 text-white fw-bold" href="/">ATTENDANCE</a>
    ...
    <div style="background-color: #D0E8F2; margin-left: 25vw; margin-top: 15vh; margin-bottom: 15vh; border-radius: 25px" class="w-50 h-75">
        ...
        <form action="/register" method="POST">
            @csrf
            <div class="row mb-3">
                <label for="inputName" class="col-sm-4 col-form-label text-end">Name</label>
                <div class="col-sm-5 ms-2">
                    <div class="input-group has-validation">
                        <input type="text" class="form-control" id="validationName" name="name" aria-describedby="validationUsername" style="background-color: #FCF8EC" >
                    </div>
                </div>
            </div>
